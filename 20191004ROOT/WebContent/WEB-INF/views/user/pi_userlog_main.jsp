							...
							<tbody>
								<tr>
									...
									<td style="padding: 10px 3px;">
										<input type="date" id="fromDate" style="width: 6.9vw; text-align: center; font-size:.7vw;" readonly="readonly" value="${fromDate}" >
										<span style="width: 8%; margin-right: 0;">~</span>
										<input type="date" id="toDate" style="width: 6.9vw; text-align: center; font-size:.7vw;" readonly="readonly" value="${toDate}" >
									</td>
