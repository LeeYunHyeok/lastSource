						...
						<table class="user_info" style="width: auto !important;">
							...
							<tbody>
								<tr>
									...
									<td style="max-width:2vw"><input type="text" style="width: 11vw; font-size:.85vw;" id="userNo" placeholder="사용자 ID를 입력하세요"></td>
									<td style="text-align: center; background-color: #d6e4ed; max-width:10vw; font-size:.85vw; padding: 10px 3px;">사용자 명</td>
									<td style="max-width:2vw;"><input type="text" style="width: 11vw; font-size:.85vw;" id="userName" placeholder="사용자명을 입력하세요"></td>
									...
									<td style="padding: 10px 3px;">
										<input type="date" id="fromDate" style="width: 7.8vw; text-align: center; font-size:.65vw; padding-right: 12px;" readonly="readonly" value="${fromDate}" >
										<span style="width: 8%; margin-right: 0;">~</span>
										<input type="date" id="toDate" style="width: 7.8vw; text-align: center; font-size:.65vw; padding-right: 12px;" readonly="readonly" value="${toDate}" >
									</td>
