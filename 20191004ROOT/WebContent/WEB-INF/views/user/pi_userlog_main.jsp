							...
							<tbody>
								<tr>
									...
									<td style="padding: 10px 3px;">
										<input type="date" id="fromDate" style="width: 7vw; text-align: center; font-size:.75vw;" readonly="readonly" value="${fromDate}" >
										<span style="width: 8%; margin-right: 3px;">~</span>
										<input type="date" id="toDate" style="width: 7vw; text-align: center; font-size:.75vw;" readonly="readonly" value="${toDate}" >
									</td>
