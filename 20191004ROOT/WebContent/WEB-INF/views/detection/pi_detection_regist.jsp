...
%>
	<div id="taskWindow" style="position:absolute; left: 650px; top: 350px; touch-action: none; width: 70%; height: 365px; z-index: 999; display:none; min-width: 30%; min-height: 200px;" class="ui-widget-content">
...
function loadTargetGrid(oGrid)
{
    ...
    oGrid.jqGrid({
        ...
        colModel: [
            { index: 'CHK',             name: 'CHK',            width: 40,  align: 'center', editable: true, edittype: 'checkbox', classes: 'pointer',
            ...
            { index: 'TYPE1',           name: 'TYPE1',          width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
            { index: 'TYPE2',           name: 'TYPE2',          width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
            { index: 'TYPE3',           name: 'TYPE3',          width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
            { index: 'TYPE4',           name: 'TYPE4',          width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
            { index: 'TYPE5',           name: 'TYPE5',          width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
            { index: 'TYPE6',           name: 'TYPE6',          width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
            { index: 'TYPE',            name: 'TYPE',           width: 100,  align: 'right', formatter:'integer', formatoptions:{thousandsSeparator: ",", defaultValue: '0'}, sortable: false},
