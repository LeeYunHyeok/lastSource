                ...
                <table class="popup_tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="radio" class="answerRadio" name="trueFalseChk" id="selectReasonTrue" value="" class="edt_sch" style="border: 0px solid #cdcdcd; width:50px; height:50px;" placeholder="정탐">
                                <input type="radio" class="wrongRadio" name="trueFalseChk" id="selectReasonFalse" value="" class="edt_sch" style="border: 0px solid #cdcdcd; width:50px; height:50px;" placeholder="오탐">
