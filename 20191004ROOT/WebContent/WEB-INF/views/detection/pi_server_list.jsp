	...
	<%@ include file="../../include/menu2.jsp"%>
		...
		<div class="content magin_t45">
			...
			<div class="left_area2 serverList_Left">
				...
				<div class="left_box2 minH_5" style="overflow: hidden;max-height: 645px;height: 613px;">
...
<!-- 			<div class="sch_left" style=" position: absolute; right: 11px; top: 0; width: 300px;">
				...
				<div class="left_box2 minW" style="height: auto; max-height: 1000px; overflow: hidden;">
