				...
				<div class="chart_area">  
					...
					<ul>
					  <li class="width80">
					   <h3>4대 개인정보 유형(30일추이)</h3>
					    ...
					    <div class="chart_box width_57" style="height: 35vw; background: #fefff0;">
							...
							function resizeGraph_One(result, status, ansyn) {
								...
								echartPie.setOption({
									...
									legend : {
										...
										color : ['#DC143C', '#006EB6', '#DC143C', '#30a1ce', '#FF8C00'],
									},
					...
					<ul>
					  <li class="width25" id="rrn_list">
					    <h3>주민등록번호</h3>
					    <div class="chart_box autoHeight" style="height: 220px; overflow:auto; background: #fefff0;">
